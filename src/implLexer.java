...
public class implLexer extends Lexer {
	...
	public static final int
		...
		TRUE=25, WHITESPACE=26, COMMENT=27, COMMENT2=28;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FLOAT", "ALL_OPERATORS", "OBRACE", "CBRACE", "PLUS", "MINUS", "MULT", 
			"DIV", "MOD", "NOT", "OR_OP", "AND_OP", "MULTI", "OPERATOR", "FALSE", 
			"TRUE", "WHITESPACE", "COMMENT", "COMMENT2"
		};
	}
